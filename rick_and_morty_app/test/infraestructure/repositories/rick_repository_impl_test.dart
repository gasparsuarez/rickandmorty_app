...
void main() {
  ...
  group('Dio tests with path [characters] ->', () {
    setUp(() {
    ...
    test('Status code 200 on get characters', () async {
      const path = '/character';

      const characters = <String, dynamic>{
        "info": {
          "count": 826,
          "pages": 42,
      ...
      dioAdapter.onGet(path, (server) => server.reply(200, characters));
    ...
    test('Fetch characters on get method', () async {
      const path = '/character';
      ...
      expect(response.data, characters);
    });
